...
Flow::Context is an ActiveRecord model. This allows flows to easily persisted between
steps. If loading the record from the database on each step will be a performance problem
for you, take a look at http://github.com/ninjudd/record_cache.
